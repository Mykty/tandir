...
public class SamsaFragment extends Fragment {
    ...
    public void refreshFoods(String version) {
        new UpdateFoodAsyncTask(getActivity(), recyclerViewFoods, mSwipeRefreshLayout, version, "samsa").execute();
    }
